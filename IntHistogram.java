...
public class IntHistogram {
    ...
    public double estimateSelectivity(Predicate.Op op, int v) {
        ...
        // extreme case(outliers) needed to handle with
        ...
        if (op == Predicate.Op.GREATER_THAN) {
            ...
            if (vf < max) {
            	vf = vf+0.01; //return slightly less than full bucket
            }
        }
        ...
        if (op == Predicate.Op.LESS_THAN_OR_EQ) {
            ...
            if (vf < max) {
            	vf = vf+0.99; //computations below return data exclusive of v, so be sure to include v's bin
            }
        }
    ...
    {
        // some code goes here
    	double avgHisSelectivity = this.avgSelectivity/this.ntups/this.ntups;
    	return avgHisSelectivity;
    }
